...
| 048 | [One way to write a set — `writeRows` — and the card's hint and record decisions as pure functions](048-card-writes.md) | P3 | S–M | LOW–MED | the unit-stamp fix (another session) | TODO — waits for the unit-stamp fix |
