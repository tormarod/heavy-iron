...
| 052 | [A unit harness that boots the app and keeps its handlers — `test/harness.js`, `bootApp()`, one history fixture](052-booted-test-harness.md) | P2 | M | LOW | — | IN PROGRESS |
