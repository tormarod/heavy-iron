...
| 047 | [The objetivo's two render memos are keyed by what they depend on; the rule's tests stop leaning on resets](047-rule-cache-keys.md) | P3 | S | LOW | — | IN PROGRESS — candidate 3's `targetFrom` split dropped (absorbed by 038 and 045) |
