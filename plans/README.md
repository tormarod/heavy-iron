...
| 046 | [One table for the profile's record — `RECORD_PARTS`, and three functions in place of a dozen helpers](done/046-record-parts.md) | P2 | M | LOW–MED | — | DONE (#PR046) — `RECORD_PARTS` + `purgeRecord`/`moveExerciseRecord`/`ensureRecord`; 0 differences in 10,000 comparisons against the old helpers; three differences on shapes no path writes, accepted (see Maintenance notes) |
