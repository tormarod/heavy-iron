...
| 052 | [A unit harness that boots the app and keeps its handlers — `test/harness.js`, `bootApp()`, one history fixture](done/052-booted-test-harness.md) | P2 | M | LOW | — | DONE — PR 1 (#152: `test/harness.js`, `bootApp()`, real-handler tests, a precache section that boots) and PR 2 (#PR0522: six history builders onto one `sessionFixture`) |
