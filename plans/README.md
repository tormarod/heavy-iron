...
| 049 | [The draw ends a rest when the session on screen changes — eight hand-written `stopRest()` calls go](049-rest-stops-with-the-session.md) | P3 | S | LOW | — | IN PROGRESS — candidate 6's event hooks dropped (one listener) |
